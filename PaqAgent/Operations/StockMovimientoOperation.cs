...
internal class StockMovimientoOperation : IOperationHandler
{
    public const string OperationKey = "informes.stock-movimiento";
    private const string DatabaseParameterName = "_database";
    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<StockMovimientoOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;
    public string OperationName { get; }

    public StockMovimientoOperation(string operationName, string storedProcedure, string connection,
        ISqlExecutor sqlExecutor, ILogger<StockMovimientoOperation> logger)
    {
