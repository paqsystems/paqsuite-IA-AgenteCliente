...
internal class RobinetPedidosOperation : IOperationHandler
{
    public const string OperationKey = "robinet.pedidos";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<RobinetPedidosOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public RobinetPedidosOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<RobinetPedidosOperation> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var spParams = new Dictionary<string, object?>
        {
            ...
            ["talon_ped"] = GetString(parameters, "talon_ped"),
