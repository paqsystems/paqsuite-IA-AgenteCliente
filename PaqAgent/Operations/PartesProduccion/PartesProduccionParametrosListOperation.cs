...
internal class PartesProduccionParametrosListOperation : IOperationHandler
{
    public const string OperationKey = "PartesProduccion.Parametros.List";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<PartesProduccionParametrosListOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public PartesProduccionParametrosListOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<PartesProduccionParametrosListOperation> logger)
    {
