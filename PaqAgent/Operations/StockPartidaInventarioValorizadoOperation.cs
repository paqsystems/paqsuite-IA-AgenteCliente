...
internal class StockPartidaInventarioValorizadoOperation : IOperationHandler
{
    public const string OperationKey = "informes.stock-partida-inventario-valorizado";
    private const string DatabaseParameterName = "_database";
    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<StockPartidaInventarioValorizadoOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;
    public string OperationName { get; }

    public StockPartidaInventarioValorizadoOperation(string operationName, string storedProcedure, string connection,
        ISqlExecutor sqlExecutor, ILogger<StockPartidaInventarioValorizadoOperation> logger)
    {
