...
internal class TesoreriaListadoSaldosOperation : IOperationHandler
{
    public const string OperationKey = "informes.tesoreria-listado-saldos";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<TesoreriaListadoSaldosOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public TesoreriaListadoSaldosOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<TesoreriaListadoSaldosOperation> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var spParams = new Dictionary<string, object?>
        {
            ...
            ["cod_cuen"] = GetString(parameters, "cod_cuen"),
            ["tipo_cuenta"] = GetString(parameters, "tipo_cuenta"),
    ...
    private static Dictionary<string, object?> MapFila(IReadOnlyDictionary<string, object?> row)
    {
        return new Dictionary<string, object?>
        {
            ["cod_cuen"] = GetRowString(row, "cod_cuen"),
            ["descripcio"] = GetRowString(row, "descripcio"),
