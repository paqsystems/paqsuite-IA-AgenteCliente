...
internal class StockPartidaListadoSaldosOperation : IOperationHandler
{
    public const string OperationKey = "informes.stock-partida-listado-saldos";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<StockPartidaListadoSaldosOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public StockPartidaListadoSaldosOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<StockPartidaListadoSaldosOperation> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var spParams = new Dictionary<string, object?>
        {
            ...
            ["nro_parti"] = GetString(parameters, "nro_parti"),
    ...
    private static Dictionary<string, object?> MapFila(IReadOnlyDictionary<string, object?> row)
    {
        return new Dictionary<string, object?>
        {
            ["cod_articu"] = GetRowString(row, "cod_articu"),
            ["articulo"] = GetRowString(row, "articulo"),
            ["cod_deposi"] = GetRowString(row, "cod_deposi"),
            ["nro_parti"] = GetRowString(row, "nro_parti"),
            ["saldo"] = GetRowDecimal(row, "saldo"),
