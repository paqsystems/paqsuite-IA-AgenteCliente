...
internal class VentasComposicionSaldosOperation : IOperationHandler
{
    public const string OperationKey = "informes.ventas-composicion-saldos";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<VentasComposicionSaldosOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public VentasComposicionSaldosOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<VentasComposicionSaldosOperation> logger)
    {
    ...
    private static Dictionary<string, object?> MapFila(IReadOnlyDictionary<string, object?> row)
    {
        return new Dictionary<string, object?>
        {
            ["cod_client"] = GetRowString(row, "cod_client"),
            ...
            ["importe_cuota"] = GetRowDecimal(row, "importe_cuota"),
            ["saldo_cuota"] = GetRowDecimal(row, "saldo_cuota"),
