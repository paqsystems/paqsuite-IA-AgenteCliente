...
internal class ComprasListadoSaldosOperation : IOperationHandler
{
    public const string OperationKey = "informes.compras-listado-saldos";
    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<ComprasListadoSaldosOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public ComprasListadoSaldosOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<ComprasListadoSaldosOperation> logger)
    {
