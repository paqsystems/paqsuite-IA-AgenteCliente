...
internal class ComprasIvaComprasOperation : IOperationHandler
{
    public const string OperationKey = "informes.compras-iva-compras";

    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<ComprasIvaComprasOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public ComprasIvaComprasOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<ComprasIvaComprasOperation> logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var spParams = new Dictionary<string, object?>
        {
            ...
            ["criterio_fecha"] = GetString(parameters, "criterio_fecha") ?? "contable",
