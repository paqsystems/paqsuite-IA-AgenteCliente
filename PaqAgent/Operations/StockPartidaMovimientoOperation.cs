...
internal class StockPartidaMovimientoOperation : IOperationHandler
{
    public const string OperationKey = "informes.stock-partida-movimiento";
    private const string DatabaseParameterName = "_database";
    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<StockPartidaMovimientoOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;
    public string OperationName { get; }

    public StockPartidaMovimientoOperation(string operationName, string storedProcedure, string connection,
        ISqlExecutor sqlExecutor, ILogger<StockPartidaMovimientoOperation> logger)
    {
    ...
    public async Task<object?> ExecuteAsync(Dictionary<string, object?> parameters, int timeoutSeconds, CancellationToken cancellationToken)
    {
        ...
        var spParams = new Dictionary<string, object?>
        {
            ...
            ["tipo_mov"] = GetString(parameters, "tipo_mov"),
