...
internal class VentasResumenCuentaOperation : IOperationHandler
{
    public const string OperationKey = "informes.ventas-resumen-cuenta";

    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<VentasResumenCuentaOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public VentasResumenCuentaOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<VentasResumenCuentaOperation> logger)
    {
