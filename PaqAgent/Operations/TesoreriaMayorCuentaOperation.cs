...
internal class TesoreriaMayorCuentaOperation : IOperationHandler
{
    public const string OperationKey = "informes.tesoreria-mayor-cuenta";

    private const string DatabaseParameterName = "_database";

    private readonly ISqlExecutor _sqlExecutor;
    private readonly ILogger<TesoreriaMayorCuentaOperation> _logger;
    private readonly string _storedProcedure;
    private readonly bool _requiresCompanyDatabase;

    public string OperationName { get; }

    public TesoreriaMayorCuentaOperation(
        string operationName,
        string storedProcedure,
        string connection,
        ISqlExecutor sqlExecutor,
        ILogger<TesoreriaMayorCuentaOperation> logger)
    {
